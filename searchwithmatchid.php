...
<main class="page-center">
  <article class="sign-up">
    <h1 class="sign-up__title">Maç Numarası ile Ara</h1>
    <p class="sign-up__subtitle">Aşağıya Girebilirsiniz</p>
    <form class="sign-up-form form" action="matchidsearc.php?type=withmatchid" method="POST">
      <label class="form-label-wrapper">
        <p class="form-label">Maç Numarası</p>
        <input class="form-input" type="text" id="matchid" name="matchid" placeholder="Maç Numarasını Girin" required>
      </label>
