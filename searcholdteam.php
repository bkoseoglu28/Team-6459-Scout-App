...
<main class="page-center">
  <article class="sign-up">
    ...
    <form class="sign-up-form form" action="oldsearc.php?teamid=" method="POST">
      <label class="form-label-wrapper">
        ...
        <p class="form-label">Yıl Girin</p>
        <input class="form-input" type="number" id="yearid" name="yearid" placeholder="İstediğiniz Yılı Girin" required>
